...
CHECH_SUPPORT = Image.open(os.path.join(path,"support.png"))
...
def is_support(image):
    ...
    if image.getpixel((843,258))==(21,106,2) and image.getpixel((928,258))==(17,53,141) and image.getpixel((1013,258))==(134,16,7):
        return True
    return False
...
def is_pcards(image):
    image = Crop_Border(image)
    # print(image.getpixel((859,275)))
    if image.getpixel((1059,59))==(0xff,0xff,0xff) and image.getpixel((1147,680))==(0x0f,0xac,0xd6) and image.getpixel((1180,681))==(0xbd,0xdc,0xfb)and image.getpixel((1212,681))==(0x0d,0x3f,0x64):
        return True
    return False
